...
namespace kalea2.Utilidades
{
    ...
    public class Reportes
    {
        ...
        public List<ReportesGuias> GetEventosCasosParaGuiasDeTransporte(string vehiculoId, string fecha)
        {
            ...
            try
            {
                string query = string.Format(@"SELECT t1.descripcion as vehiculo, t2.codigoevento, t2.codigoarticulo, t3.NOMBRE_LARGO AS descripcion, t2.cantidad, t4.nombre_vendedor as vendedor, t0.nombrecliente,T0.personarecepcion, t0.telefono, t0.celular, t0.direccionentrega, 
                    ...
                    AND T0.ESTADO='A'
                    GROUP BY t1.descripcion, t2.codigoevento, t2.codigoarticulo, t3.NOMBRE_LARGO, t2.cantidad, t4.nombre_vendedor , t0.nombrecliente,t0.personarecepcion, t0.telefono, t0.celular, t0.direccionentrega, 
